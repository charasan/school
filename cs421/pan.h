...
#define nstates1	24	/* Q */
#define endstate1	23
short src_ln1 [] = {
	  0,  35,  36,  38,  39,  39,  39,  39, 
	 40,  40,  38,  42,  42,  42,  37,  44, 
	 37,  44,  45,  46,  34,  48,  34,  48, 
	  0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "pan.___", 1, 23 },
...
#define nstates0	24	/* P */
#define endstate0	23
short src_ln0 [] = {
	  0,  17,  18,  20,  21,  21,  21,  21, 
	 22,  22,  20,  24,  24,  24,  19,  26, 
	 19,  26,  27,  28,  16,  30,  16,  30, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "pan.___", 1, 23 },
